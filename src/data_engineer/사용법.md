...
cat_path, _ = make_classIDtxt(anntation_dir)

fast_dataset = FasterRCNNDataset(image_dir, anntation_dir, cat_path)                  #   <-- train 데이터 class 객체 생성
...
train_dataset = FasterRCNNDataset(image_dir, anntation_dir, cat_path, img_path_list_mode=True, img_path_list=train_imgs_path)   #   img_path_list_mode == 이미지 경로 리스트 형태로 받음
valid_dataset = FasterRCNNDataset(image_dir, anntation_dir, cat_path, img_path_list_mode=True, img_path_list=val_imgs_path)
