...
from Faster_RCNN_dataset import FasterRCNNDataset, training_transforms, validation_transforms
...
TRAIN_ANNT_DIR = os.path.join(BASE_DIR, 'data', 'processed', 'train_annotations_박스위치조정')
